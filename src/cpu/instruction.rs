...
impl Instruction {
    ...
    pub fn get_opcode_type_nonprefix(&self) -> Operation {
        match self.0 {
            ...
            0x41 ... 0x4F | 0x50 ... 0x5F 
                | 0x60 ... 0x6F | 0x70 ... 0x7F 
                | 0x06 | 0x16 | 0x26 | 0x36 | 0x0A 
                | 0x1A | 0x2A | 0x3A | 0x0E | 0x1E 
                | 0x2E | 0x3E | 0x06 | 0x16 | 0x26
                | 0x36 | 0xE2 | 0xF2 | 0xA2 | 0xA2 => Operation::Ld8, //Match will short-circuit the values that are in this range that go to Nop
            ...
            0x04 | 0x14 | 0x24 | 0x34 | 
            0x0C | 0x1C | 0x2C | 0x3C => Operation::Inc8

            0x09 | 0x19 | 0x29 | 0x39 | 0xE8 => Operation::Add16,

            0x05 | 0x15 | 0x25 | 0x35 |
            0x0D | 0x1D | 0x2D | 0x3D => Operation::Dec8,
            ...
            0xC7 | 0xD7 | 0xE7 | 0xF7 |
            0xCF | 0xDF | 0xEF | 0xFF => Operation::Rst,
