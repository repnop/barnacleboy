...
pub const CART_ROM_BANK_00_SIZE: usize = (CART_ROM_BANK_00_END - CART_ROM_BANK_00_START + 1) as usize;

pub const CART_ROM_BANK_NN_START: u16 = 0x4000;
pub const CART_ROM_BANK_NN_END: u16 = 0x7FFF;
pub const CART_ROM_BANK_NN_SIZE: usize = (CART_ROM_BANK_NN_END - CART_ROM_BANK_NN_START + 1) as usize;
...
pub const CART_EXTERNAL_RAM_SIZE: usize = (CART_EXTERNAL_RAM_END - CART_EXTERNAL_RAM_START + 1) as usize;
...
pub const WORK_RAM_ECHO_START: u16 = 0xE000; // Same memory as WORK_RAM_BANK_0_START to (WORK_RAM_BANK_1_END - 0x0200)
...
pub const SPRITE_ATTRIBUTE_TABLE_SIZE: usize = (SPRITE_ATTRIBUTE_TABLE_END - SPRITE_ATTRIBUTE_TABLE_START + 1) as usize;
